...
/// Split message text into (display, Option<href>) pairs.
/// href is Some for links (always includes protocol), None for plain text.
...
/// Try to fetch Open Graph / meta tags directly from the browser.
/// Silently returns None on CORS errors or non-HTML responses.
...
/// Renders message text with URLs as clickable underlined links.
#[component]
